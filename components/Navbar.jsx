...
import NavLogo from '../public/images/sm.jpg'
      ...
      <div  className='flex justify-around items-center w-full h-full px-2 2xl:px-16'>
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className='hidden font-semibold md:flex '>
            <li className='ml-10 text-sm uppercase hover:border-b hover:text-darkGrayishBlue'>
              <Link href='/'>Home</Link> 
            </li>
            <li className='ml-10 text-sm uppercase hover:border-b  hover:text-darkGrayishBlue'>
            ...
            <li class="ml-10 text-sm uppercase hover:border-b hover:text-darkGrayishBlue rounded-lg focus:outline-none  md:block">
